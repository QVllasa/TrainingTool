...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.matCombo, 2, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.label_4.setObjectName("label_4")
        self.gridLayout_2.addWidget(self.label_4, 2, 0, 1, 1)
        self.materialList = QtWidgets.QTableWidget(self.gridLayoutWidget_2)
        self.materialList.setObjectName("materialList")
        self.materialList.setColumnCount(3)
        self.materialList.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.materialList.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.materialList.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.materialList.setHorizontalHeaderItem(2, item)
        self.materialList.horizontalHeader().setVisible(True)
        self.materialList.horizontalHeader().setCascadingSectionResizes(False)
        self.materialList.horizontalHeader().setStretchLastSection(True)
        self.gridLayout_2.addWidget(self.materialList, 0, 0, 1, 4)
        self.addPart = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.addPart.setObjectName("addPart")
        self.gridLayout_2.addWidget(self.addPart, 1, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.materialList.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Firstname"))
        item = self.materialList.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Lastname"))
        item = self.materialList.horizontalHeaderItem(2)
